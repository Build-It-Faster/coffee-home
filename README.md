...
```text
https://build-it-faster.github.io/coffee-home/
```

For Google OAuth production verification, use a verified domain that you own for the homepage and privacy policy URLs.
